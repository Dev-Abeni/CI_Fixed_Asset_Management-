    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Departments</h2>
                &nbsp;
                <a href="<?php echo base_url('departments/create'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add new department</a>
                            ...
                            <tbody>
                                <?php foreach($departments as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo base_url("departments/change/$row->department_id"); ?>' class="btn btn-success btn-sm">
                                            <i class="fa fa-pencil"></i> Edit</a>
                                            <a href='<?php echo base_url("departments/delete/$row->department_id"); ?>' class="btn btn-danger btn-sm">
