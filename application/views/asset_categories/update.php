...
<div class="right_col" role="main">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
            <h2>Update an asset category</h2>
            ...
            <div class="x_content">
                ...
                <?php echo form_open("asset_categories/update/$category->category_id", $attributes) ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php 
                                echo form_input([
                                    ...
                                    'value' => set_value('depreciation_percent', $category->depreciation_percent)
                                ]); 
                            ?>
